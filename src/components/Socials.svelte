<script lang="ts">
	import MediumIcon from '~icons/mingcute/medium-fill'
	import TwitterIcon from '~icons/devicon/twitter'
	import GitHubIcon from '~icons/devicon/github'
	import BehanceIcon from '~icons/simple-icons/behance'
	import LinkedInIcon from '~icons/devicon/linkedin'
	import PolyworkIcon from '~icons/simple-icons/polywork'
