...
<div class="flex w-full flex-col items-center justify-center text-center">
	...
	<div class="mt-12 flex w-full flex-col items-center">
		<h1 class="max-w-sm text-4xl font-bold text-gray-400 sm:max-w-xl sm:text-6xl">
			<span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">Layer0</span> has evolved, and so has
			<span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">Rishi</span>.
		</h1>
	</div>
	<span class="mt-12 w-full text-lg text-gray-400"> A look back at Rishi's contribution to Layer0 from August 2021 to July 2022</span>
</div>
<div class="flex w-full flex-col items-center justify-center">
	<div class="mt-48 flex w-full flex-col items-center text-center">
		<h1 class="max-w-xs text-4xl font-bold text-gray-400 sm:max-w-xl sm:text-6xl">
			<span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">Layer0</span> docs got
			<span class="font-normal line-through">better</span>
			<span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">Richer</span>.
		</h1>
	</div>
	<span class="mt-12 w-full text-center text-2xl text-gray-400">
		He contributed over
		<span class="border-b border-gray-400 bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text pb-1 text-transparent"> 165 meaningful commits! </span>
	</span>
	<div class="flex flex-col flex-wrap place-content-center items-stretch sm:flex-row sm:gap-x-5">
		<div class="mt-12 flex w-[330px] flex-row items-center gap-x-8 rounded border border-gray-400 p-5">
			<span class="w-[100px] bg-gradient-to-br from-blue-400 via-pink-700 to-red-800 bg-clip-text text-5xl font-bold text-transparent">#47</span>
			<span class="">frameworks now officially documented with Layer0.</span>
		</div>
		<div class="mt-12 flex w-[330px] flex-row items-center gap-x-8 rounded border border-gray-400 p-5">
			<span class="w-[100px] bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-6xl font-bold text-transparent">#1</span>
			<div class="flex flex-col items-start">
				<span class="">the first one to curate a full guide on Layer0 traditional template.</span>
				<a href="https://rishi-raj-jain-layer0-traditional-guide-default.layer0-limelight.link" class="mt-3 border-b border-gray-400 text-sm text-gray-400">
					Take me to the guide &rarr;
				</a>
			</div>
		</div>
	</div>
...
<div class="flex w-full flex-col items-start justify-center">
	<h2 class="mt-48 max-w-3xl text-4xl font-bold text-gray-400 sm:text-6xl">
		He could not see the future, but
		<span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">documented</span>
...
<div class="flex w-full flex-col items-start justify-center">
	<h2 class="mt-48 max-w-3xl text-4xl font-bold text-gray-400 sm:text-6xl">
		He templated the present, and created a
	...
	<div class="mt-12 flex max-w-[512px] flex-row items-center gap-x-8 rounded border border-gray-400 p-5">
		...
		<div class="flex flex-col items-start">
			<span class="">new frameworks added that can be deployed to Layer0, right now with a single click.</span>
		</div>
	</div>
</div>
<div class="flex w-full flex-col items-start justify-center">
	<h2 class="mt-48 text-4xl font-bold text-gray-400 sm:text-6xl">
		Sharing docs is more than just sharing a link. He ideated, <span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">created</span>
		and <span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">documented</span> a dynamic Open Graph Image Generator, deployable with
		Layer0 to include <span class="bg-gradient-to-br from-blue-400 via-pink-700 to-teal-600 bg-clip-text text-transparent">Rich Previews</span> to Docs.
	</h2>
	<div class="flex w-full flex-row flex-wrap items-center">
		<div class="flex w-full flex-col items-start md:w-1/2">
			<div class="mt-12 flex flex-row items-center gap-x-5">
				<svg class="h-[32px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 499.36" role="img"
			...
			<div class="mt-12 flex flex-row items-center gap-x-5">
				...
				<a
					...
					href="https://dev.to/reeshee/dynamic-open-graph-image-generator-with-layer0-nextjs-tailwindcss-chrome-aws-lambda-and-puppeteer-core-3e94"
				>
					https://bit.ly/3NXckO8
				</a>
			</div>
		</div>
		<div class="mt-12 w-full md:w-1/2">
			<img loading="lazy" alt="OG Preview" class="w-full rounded border" src="https://layer0-docs-og-image-default.layer0.link/api?title=Rich Preview" />
		</div>
	</div>
</div>
<div class="flex w-full flex-col items-center justify-center">
	...
	<div class="flex w-full flex-col items-center sm:flex-row">
		...
		<div class="mt-12 flex w-full flex-col px-10 text-xl md:text-2xl">
			...
			<span class="mt-3"> Jeff Patzer, Director Strategic Solutions Architecture at Layer0</span>
		</div>
	</div>
</div>
<div class="flex w-full flex-col items-start justify-center">
...
<div class="flex w-full flex-col items-start justify-center">
	...
	<span class="mt-5 text-2xl"> Venue: <span class="font-bold">HACKNITR 3.0</span></span>
	<h2 class="mt-24 text-4xl font-bold text-gray-400">
