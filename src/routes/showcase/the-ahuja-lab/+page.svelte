...
<h2 class="text-md font-light text-gray-400 sm:text-xl">The Ahuja Lab - Meet the lab that uses a hybrid approach involving Artificial Intelligence and Molecular Biology</h2>
...
<div class="mt-24 grid grid-cols-1 gap-y-8 sm:grid-cols-2">
	...
	<span class="rounded border border-gray-200 p-5 text-xl font-light text-black">
		...
		I opened from phone and it worked like a charm! <br />
